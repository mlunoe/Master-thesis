...
%	\centering
%	
%	\def\mygraphic{\includegraphics[width=\textwidth]{img/use-cases}}
%	%\newlength{\graphicheight}
...
%\cleardoublepage\include{FrontBackmatter/02_resume} % Abstract page
%\cleardoublepage\include{FrontBackmatter/03_preface} % Abstract page
%\cleardoublepage\include{FrontBackmatter/04_acknowledge} % Acknowledgements page
...
\include{08_design}
\include{09_implementation}

\cleardoublepage % Empty page before the start of the next part

%------------------------------------------------

\ctparttext{Text for part 3.} % Text on the Part 1 page describing  the content in Part 1
...
\include{A_user-needs} % Appendix A
